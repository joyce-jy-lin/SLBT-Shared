...
b1 <-  read.csv("/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Data 2020/Tooth Analysis/Dartmouth Post-ICP-MS Processing/Output/SLBT_Tooth_Data1_2023_09_22_proc3flags.csv", 
                header = T)
b1_old <-  read.csv("/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Data 2020/Tooth Analysis/Dartmouth Post-ICP-MS Processing/Output/SLBT_Tooth_Data1_2023_08_17_proc3flags.csv", 
                    header = T)
class(b1_old$hg202_ppm_lod_howell_mean)

## Batches 1-3 (DON'T TAKE BATCH ONE FROM THIS FILE THOUGH!)
b123 <-  read.csv("/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Data 2020/Tooth Analysis/Dartmouth Post-ICP-MS Processing/Output/SLBT_Tooth_Data_All_2023_03_09.csv", 
                  header = T)
...
## Batch 4.1 
b4 <- read.csv("/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Data 2020/Tooth Analysis/Dartmouth Post-ICP-MS Processing/Output/SLBT_Tooth_Data4_2023_04_14_proc3flags.csv", 
               header = T)

## Batch 4.2 
b4_2 <- read.csv("/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Data 2020/Tooth Analysis/Dartmouth Post-ICP-MS Processing/Output/SLBT_Tooth_Data4_part2_2023_08_01_proc3flags.csv", 
                 header = T)
...
tooth_full <- full_join(tooth_i2, b4_2)

write_csv(tooth_full, "/Volumes/shared/EOME/Weisskopf/Saint_Louis_Baby_Teeth_Study/Individuals/Joyce/tooth_full.csv")

# Joyce data vis 11/16/2023 -------------------------
